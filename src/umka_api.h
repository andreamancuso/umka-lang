...
typedef bool (*UmkaSetDynArrayItem)             (Umka *umka, void *array, int64_t index, UmkaStackSlot item);
typedef bool (*UmkaGetDynArrayItem)             (Umka *umka, const void *array, int64_t index, UmkaStackSlot *item);
typedef bool (*UmkaGetDynArrayAnyItem)          (Umka *umka, const void *array, int64_t index, UmkaAny *item);
typedef bool (*UmkaRetainHostDynArrayItem)      (Umka *umka, const void *array, int64_t index, UmkaHostHandle *handle);
...
typedef struct
{
    ...
    UmkaSetDynArrayItem umkaSetDynArrayItem;
    UmkaGetDynArrayItem umkaGetDynArrayItem;
    UmkaGetDynArrayAnyItem umkaGetDynArrayAnyItem;
    UmkaRetainHostDynArrayItem umkaRetainHostDynArrayItem;
